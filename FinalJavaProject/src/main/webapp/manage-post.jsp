			...
			<aside>
				<ul>
					<li><a href="add-post.jsp"><i class="fa fa-plus"></i>
							<h5>Add Post</h5></a></li>
					<li><a href="manage-post.jsp" class="active"><i
							class="fa fa-edit"></i>
				...
				<table>
					...
					<tbody>
						...
						try {
							...
							String query = "select * from posts where post_userid=?;";
						...
						<tr>
							...
							<td><%= rs.getString("post_categoryid") %></td>
							<td><a href="edit-post.jsp?post_id=<%= rs.getString("post_id") %>" class="btn sm">Edit</a></td>
							<td><a href="delete-post.jsp?post_id=<%= rs.getString("post_id") %>" class="btn sm danger">Delete</a></td>
						</tr>
						<%
						}
